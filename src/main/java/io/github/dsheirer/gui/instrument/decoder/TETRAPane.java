...
import io.github.dsheirer.module.decode.tetra.TETRADecoderInsturmented;
...
public class TETRAPane extends ComplexDecoderPane
{
    private final static Logger mLog = LoggerFactory.getLogger(TETRAPane.class);
    ...
    private TETRADecoderInsturmented mDecoder = new TETRADecoderInsturmented(new DecodeConfigTETRA());

    public TETRAPane()
    {
        super(DecoderType.TETRA);
        init();
    }
    ...
    public void setSampleRate(double sampleRate)
    {
        ...
        double samplesPerSymbol = sampleRate / 18000.0;
    ...
    private TETRADecoderInsturmented getDecoder()
    {
        return mDecoder;
    }
